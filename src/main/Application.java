...
//Predicate, Function и Consumer - это функциональные интерфейсы встроенные в JDK.
//Predicate - принимает объект и возвращает boolean значение;
//Function - принимает объект одного типа и возвращает объект другого типа;
//Consumer - принимает объект выполняет действие и ничего не возвращает; 

//Терминальная операция - это операция с потоком вернувшая конкретный результат, и после этого другие операции с потоком не возможны. 
